#******************************************************************************
# Generated by VisualTeensy V1.4.0 on 11/6/2021 at 12:43 PM
#
# Board              Teensy 4.1
# USB Type           Serial
# CPU Speed          600 MHz
...
LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := SdFat SPI Wire RAW_MPU6050 Motion_MPU6050 Logger ADXL357
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=155 -DARDUINO_TEENSY41 -DARDUINO=10813 -DTEENSY_BUILD
